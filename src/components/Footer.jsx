      ...
      <div className={m.container}>
        <div className={m.sub}>
          ...
          <div className={m.social}>
            <div><a href=""><i className="fa-brands fa-square-facebook"></i></a></div>
            <div><a href=""><i className="fa-brands fa-square-whatsapp"></i></a></div>
            <div><a href=""><i className="fa-brands fa-square-x-twitter"></i></a></div>
            <div><a href=""><i className="fa-brands fa-linkedin"></i></a></div>
            <div><a href=""><i className="fa-brands fa-tiktok"></i></a></div>
          </div>
        </div>
